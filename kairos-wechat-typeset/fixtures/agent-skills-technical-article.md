...
本文用一篇标准技术文章的结构介绍 Agent Skills，同时展示 `song` 主题在微信公众号正文里的技术排版能力。资料来源包括 [Agent Skills Overview](https://agentskills.io/home)、[Specification](https://agentskills.io/specification) 和 [Best practices for skill creators](https://agentskills.io/skill-creation/best-practices)。
